...
\DoxyCodeLine{00047       rclcpp::get\_logger(\textcolor{stringliteral}{"{}smacc2"{}}), \textcolor{stringliteral}{"{}[ClRosLaunch] starting ros launch thread "{}} << ss.str());}
\DoxyCodeLine{00048     std::stringstream cmd;}
\DoxyCodeLine{00049     cmd << \textcolor{stringliteral}{"{}ros2 launch "{}} << packageName << \textcolor{stringliteral}{"{} "{}} << launchFileName;}
\DoxyCodeLine{00050 }
\DoxyCodeLine{00051     std::array<char, 128> buffer;}
\DoxyCodeLine{00052     std::string result;}
\DoxyCodeLine{00053     std::unique\_ptr<FILE, \textcolor{keyword}{decltype}(\&pclose)> pipe(popen(cmd.str().c\_str(), \textcolor{stringliteral}{"{}r"{}}), pclose);}
\DoxyCodeLine{00054     \textcolor{keywordflow}{if} (!pipe)}
\DoxyCodeLine{00055     \{}
\DoxyCodeLine{00056       \textcolor{keywordflow}{throw} std::runtime\_error(\textcolor{stringliteral}{"{}popen() failed!"{}});}
\DoxyCodeLine{00057     \}}
\DoxyCodeLine{00058 }
\DoxyCodeLine{00059     std::stringstream ss;}
\DoxyCodeLine{00060     \textcolor{keywordtype}{bool} cancelled = \textcolor{keyword}{false};}
\DoxyCodeLine{00061     \textcolor{keywordflow}{while} (fgets(buffer.data(), buffer.size(), pipe.get()) != \textcolor{keyword}{nullptr} \&\&}
\DoxyCodeLine{00062            !(cancelled = cancelCondition()))}
\DoxyCodeLine{00063     \{}
\DoxyCodeLine{00064       ss << buffer.data();}
\DoxyCodeLine{00065     \}}
\DoxyCodeLine{00066 }
\DoxyCodeLine{00067     result = ss.str();}
\DoxyCodeLine{00068     RCLCPP\_WARN\_STREAM(rclcpp::get\_logger(\textcolor{stringliteral}{"{}smacc2"{}}), \textcolor{stringliteral}{"{}[ClRosLaunch] RESULT = \(\backslash\)n "{}} << ss.str());}
