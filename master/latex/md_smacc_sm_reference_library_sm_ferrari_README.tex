...
A simple, but complete state machine example. We highly recommend using this example as a starting point for users\textquotesingle{} state machine projects.~\newline
 \href{https://robosoft-ai.github.io/SMACC2_Documentation/master/html/namespacesm__ferrari.html}{\texttt{ Doxygen Namespace \& Class Reference}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{ros2 launch sm\_ferrari sm\_ferrari.launch}
