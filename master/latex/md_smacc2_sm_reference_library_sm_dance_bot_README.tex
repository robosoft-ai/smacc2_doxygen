...
A full-\/featured state machine example, that highlights the capabilities of SMACC2 \& the ROS2 Navigation Stack via the Move\+BaseZ Client. .~\newline
 \href{https://robosoft-ai.github.io/SMACC2_Documentation/master/html/namespacesm__dance__bot.html}{\texttt{ Doxygen Namespace \& Class Reference}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{ros2 launch sm\_dance\_bot sm\_dance\_bot.launch}
