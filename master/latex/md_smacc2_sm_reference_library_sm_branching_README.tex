...
A state machine example that highlights some of the advanced layout features available in the SMACC2 RTA.~\newline
 \href{https://robosoft-ai.github.io/SMACC2_Documentation/master/html/namespacesm__branching.html}{\texttt{ Doxygen Namespace \& Class Reference}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{ros2 launch sm\_branching sm\_branching.launch}
