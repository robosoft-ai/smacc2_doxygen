...
A state machine sketch for the Respira\+Works Ventilator~\newline
 \href{https://robosoft-ai.github.io/SMACC2_Documentation/master/html/namespacesm__respira__1.html}{\texttt{ Doxygen Namespace \& Class Reference}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{ros2 launch sm\_respira sm\_respira.launch}
