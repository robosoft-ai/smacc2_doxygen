...
\DoxyCodeLine{00065       \textcolor{keywordflow}{while} (fgets(buffer.data(), buffer.size(), pipe.get()) != \textcolor{keyword}{nullptr} \&\&}
\DoxyCodeLine{00066              !(cancelled = cancelCondition()))}
\DoxyCodeLine{00067       \{}
\DoxyCodeLine{00068         ss << buffer.data();}
\DoxyCodeLine{00069       \}}
\DoxyCodeLine{00070 }
\DoxyCodeLine{00071       result = ss.str();}
\DoxyCodeLine{00072       RCLCPP\_WARN\_STREAM(}
\DoxyCodeLine{00073         rclcpp::get\_logger(\textcolor{stringliteral}{"{}smacc2"{}}), \textcolor{stringliteral}{"{}[ClRosLaunch static]] RESULT = \(\backslash\)n "{}} << ss.str());}
