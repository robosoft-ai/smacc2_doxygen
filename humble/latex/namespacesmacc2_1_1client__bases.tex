...
\begin{DoxyCode}{0}
\DoxyCodeLine{00258\ \{\ \mbox{\hyperlink{namespacesmacc2_1_1client__bases_a69252b7282d90f069ab71a854f5e46e8}{killProcessesRecursive}}(originalPid);\ \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00215\ \{}
\DoxyCodeLine{00216\ \ \ std::string\ command\ =\ \textcolor{stringliteral}{"{}pgrep\ -\/P\ "{}}\ +\ std::to\_string(pid);}
\DoxyCodeLine{00217\ \ \ FILE\ *\ pipe\ =\ popen(command.c\_str(),\ \textcolor{stringliteral}{"{}r"{}});}
\DoxyCodeLine{00218\ }
...
\DoxyCodeLine{00223\ \ \ \}}
\DoxyCodeLine{00224\ }
\DoxyCodeLine{00225\ \ \ \textcolor{keywordtype}{char}\ buffer[128];}
\DoxyCodeLine{00226\ \ \ std::string\ result\ =\ \textcolor{stringliteral}{"{}"{}};}
\DoxyCodeLine{00227\ }
\DoxyCodeLine{00228\ \ \ \textcolor{keywordflow}{while}\ (fgets(buffer,\ \textcolor{keyword}{sizeof}(buffer),\ pipe)\ !=\ NULL)}
\DoxyCodeLine{00229\ \ \ \{}
\DoxyCodeLine{00230\ \ \ \ \ result\ +=\ buffer;}
\DoxyCodeLine{00231\ \ \ \}}
\DoxyCodeLine{00232\ }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{00171\ \{}
\DoxyCodeLine{00172\ \ \ \mbox{\hyperlink{structsmacc2_1_1client__bases_1_1ProcessInfo}{ProcessInfo}}\ info;}
\DoxyCodeLine{00173\ \ \ info.\mbox{\hyperlink{structsmacc2_1_1client__bases_1_1ProcessInfo_a4b89d5acba7e751d5384a6bc473758bb}{pid}}\ =\ -\/1;\ \ \textcolor{comment}{//\ Inicializar\ el\ PID\ a\ -\/1\ (indicando\ error)}}
\DoxyCodeLine{00174\ \ \ info.\mbox{\hyperlink{structsmacc2_1_1client__bases_1_1ProcessInfo_a37ce0d01a9330b932d540c9a8973d563}{pipe}}\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00175\ }
\DoxyCodeLine{00176\ \ \ \textcolor{keywordtype}{int}\ pipefd[2];\ \ \textcolor{comment}{//\ Descriptor\ de\ archivo\ para\ el\ pipe}}
\DoxyCodeLine{00177\ }
\DoxyCodeLine{00178\ \ \ \textcolor{keywordflow}{if}\ (pipe(pipefd)\ ==\ -\/1)}
\DoxyCodeLine{00179\ \ \ \{}
\DoxyCodeLine{00180\ \ \ \ \ perror(\textcolor{stringliteral}{"{}pipe"{}});}
\DoxyCodeLine{00181\ \ \ \ \ \textcolor{keywordflow}{return}\ info;}
\DoxyCodeLine{00182\ \ \ \}}
\DoxyCodeLine{00183\ }
\DoxyCodeLine{00184\ \ \ pid\_t\ pid\ =\ fork();}
\DoxyCodeLine{00185\ }
\DoxyCodeLine{00186\ \ \ \textcolor{keywordflow}{if}\ (pid\ ==\ 0)}
\DoxyCodeLine{00187\ \ \ \{}
\DoxyCodeLine{00188\ \ \ \ \ \textcolor{comment}{//\ Esto\ se\ ejecuta\ en\ el\ proceso\ hijo}}
\DoxyCodeLine{00189\ \ \ \ \ close(pipefd[0]);\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Cerramos\ el\ extremo\ de\ lectura\ del\ pipe\ en\ el\ proceso\ hijo}}
\DoxyCodeLine{00190\ \ \ \ \ dup2(pipefd[1],\ STDOUT\_FILENO);\ \ \textcolor{comment}{//\ Redireccionamos\ la\ salida\ estándar\ al\ pipe}}
\DoxyCodeLine{00191\ \ \ \ \ close(pipefd[1]);\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Cerramos\ el\ extremo\ de\ escritura\ del\ pipe\ en\ el\ proceso\ hijo}}
\DoxyCodeLine{00192\ }
\DoxyCodeLine{00193\ \ \ \ \ execl(\textcolor{stringliteral}{"{}/bin/sh"{}},\ \textcolor{stringliteral}{"{}/bin/sh"{}},\ \textcolor{stringliteral}{"{}-\/c"{}},\ command,\ \textcolor{keyword}{nullptr});\ \ \textcolor{comment}{//\ Ejecuta\ el\ comando\ dado}}
\DoxyCodeLine{00194\ }
\DoxyCodeLine{00195\ \ \ \ \ \textcolor{comment}{//\ Si\ execl\ retorna,\ significa\ que\ hubo\ un\ error}}
\DoxyCodeLine{00196\ \ \ \ \ std::cerr\ <<\ \textcolor{stringliteral}{"{}Error\ al\ ejecutar\ el\ comando:\ "{}}\ <<\ command\ <<\ std::endl;}
\DoxyCodeLine{00197\ \ \ \ \ \_exit(1);\ \ \textcolor{comment}{//\ Usar\ \_exit\ para\ evitar\ la\ ejecución\ de\ códigos\ de\ salida\ de\ manejo\ de\ errores}}
\DoxyCodeLine{00198\ \ \ \}}
