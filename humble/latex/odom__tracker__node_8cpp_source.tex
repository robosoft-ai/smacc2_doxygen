...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00021}00021 \textcolor{preprocessor}{\#include <odom\_tracker/CpOdomTrackerAction.h>}}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00025}\mbox{\hyperlink{odom__tracker__node_8cpp_aa74d24df0e1897cc9c12bbe6a42af4ae}{00025}} \textcolor{keyword}{typedef} actionlib::SimpleActionServer<odom\_tracker::CpOdomTrackerAction> \mbox{\hyperlink{odom__tracker__node_8cpp_aa74d24df0e1897cc9c12bbe6a42af4ae}{Server}};}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00030}\mbox{\hyperlink{classCpOdomTrackerActionServer}{00030}} \textcolor{keyword}{class }\mbox{\hyperlink{classCpOdomTrackerActionServer}{CpOdomTrackerActionServer}}}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00033}\mbox{\hyperlink{classCpOdomTrackerActionServer_a6d1531afe519f97f54756fc331e45918}{00033}}   std::shared\_ptr<Server> \mbox{\hyperlink{classCpOdomTrackerActionServer_a6d1531afe519f97f54756fc331e45918}{as\_}};}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00043}\mbox{\hyperlink{classCpOdomTrackerActionServer_ae721733fba5870ea4577f4200723fa2a}{00043}}   \textcolor{keywordtype}{void} \mbox{\hyperlink{classCpOdomTrackerActionServer_ae721733fba5870ea4577f4200723fa2a}{execute}}(}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00044}00044     \textcolor{keyword}{const} CpOdomTrackerGoalConstPtr \& goal)  \textcolor{comment}{// Note: "{}Action"{} is not appended to DoDishes here}}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00050}00050         \textcolor{keywordflow}{case} CpOdomTrackerGoal::RECORD\_PATH:}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00051}00051           \mbox{\hyperlink{classCpOdomTrackerActionServer_afcc8541ee3ae3cfc4af3ec804e6980a0}{odomTracker}}.\mbox{\hyperlink{classcl__nav2z_1_1odom__tracker_1_1CpOdomTracker_ab459705febf58fd0b961d455f2b2dcbe}{setWorkingMode}}(WorkingMode::RECORD\_PATH);}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00054}00054         \textcolor{keywordflow}{case} CpOdomTrackerGoal::CLEAR\_PATH:}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00055}00055           \mbox{\hyperlink{classCpOdomTrackerActionServer_afcc8541ee3ae3cfc4af3ec804e6980a0}{odomTracker}}.\mbox{\hyperlink{classcl__nav2z_1_1odom__tracker_1_1CpOdomTracker_ab459705febf58fd0b961d455f2b2dcbe}{setWorkingMode}}(WorkingMode::CLEAR\_PATH);}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00058}00058         \textcolor{keywordflow}{case} CpOdomTrackerGoal::IDLE:}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00059}00059           \mbox{\hyperlink{classCpOdomTrackerActionServer_afcc8541ee3ae3cfc4af3ec804e6980a0}{odomTracker}}.\mbox{\hyperlink{classcl__nav2z_1_1odom__tracker_1_1CpOdomTracker_ab459705febf58fd0b961d455f2b2dcbe}{setWorkingMode}}(WorkingMode::IDLE);}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00062}00062         \textcolor{keywordflow}{case} CpOdomTrackerGoal::START\_BROADCAST\_PATH:}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00063}00063           \mbox{\hyperlink{classCpOdomTrackerActionServer_afcc8541ee3ae3cfc4af3ec804e6980a0}{odomTracker}}.\mbox{\hyperlink{classcl__nav2z_1_1odom__tracker_1_1CpOdomTracker_ab26073027a138767b682ec80ce85555e}{setPublishMessages}}(\textcolor{keyword}{true});}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00070}00070         \textcolor{keywordflow}{case} CpOdomTrackerGoal::PUSH\_PATH:}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00071}00071           \mbox{\hyperlink{classCpOdomTrackerActionServer_afcc8541ee3ae3cfc4af3ec804e6980a0}{odomTracker}}.\mbox{\hyperlink{classcl__nav2z_1_1odom__tracker_1_1CpOdomTracker_a5731914838169f20d2f34c919ef4dac1}{pushPath}}();}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00074}00074         \textcolor{keywordflow}{case} CpOdomTrackerGoal::POP\_PATH:}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00075}00075           \mbox{\hyperlink{classCpOdomTrackerActionServer_afcc8541ee3ae3cfc4af3ec804e6980a0}{odomTracker}}.\mbox{\hyperlink{classcl__nav2z_1_1odom__tracker_1_1CpOdomTracker_a095f5ebdd452f266077fac90410c0c12}{popPath}}();}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00083}00083           \mbox{\hyperlink{classCpOdomTrackerActionServer_a6d1531afe519f97f54756fc331e45918}{as\_}}-\/>setAborted();}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00087}00087       \mbox{\hyperlink{classCpOdomTrackerActionServer_a6d1531afe519f97f54756fc331e45918}{as\_}}-\/>setSucceeded();}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00092}00092       \mbox{\hyperlink{classCpOdomTrackerActionServer_a6d1531afe519f97f54756fc331e45918}{as\_}}-\/>setAborted();}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00101}\mbox{\hyperlink{classCpOdomTrackerActionServer_a87b52becfbea05097d198d3ac0386d3c}{00101}}   \textcolor{keywordtype}{void} \mbox{\hyperlink{classCpOdomTrackerActionServer_a87b52becfbea05097d198d3ac0386d3c}{run}}()}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00106}00106     \mbox{\hyperlink{classCpOdomTrackerActionServer_a6d1531afe519f97f54756fc331e45918}{as\_}} = std::make\_shared<Server>(}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00107}00107       n, \textcolor{stringliteral}{"{}odom\_tracker"{}},}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00108}00108       std::bind(\&\mbox{\hyperlink{classCpOdomTrackerActionServer_ae721733fba5870ea4577f4200723fa2a}{CpOdomTrackerActionServer::execute}}, \textcolor{keyword}{this}, std::placeholders::\_1), \textcolor{keyword}{false});}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00109}00109     RCLCPP\_INFO(getLogger(), \textcolor{stringliteral}{"{}Starting CpOdomTracker Action Server"{}});}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00110}00110 }
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00111}00111     \mbox{\hyperlink{classCpOdomTrackerActionServer_a6d1531afe519f97f54756fc331e45918}{as\_}}-\/>start();}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00112}00112 }
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00113}00113     ros::spin();}
...
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00116}00116 }
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00117}\mbox{\hyperlink{odom__tracker__node_8cpp_a3c04138a5bfe5d72780bb7e82a18e627}{00117}} \textcolor{keywordtype}{int} \mbox{\hyperlink{odom__tracker__node_8cpp_a3c04138a5bfe5d72780bb7e82a18e627}{main}}(\textcolor{keywordtype}{int} argc, \textcolor{keywordtype}{char} ** argv)}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00118}00118 \{}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00119}00119   ros::init(argc, argv, \textcolor{stringliteral}{"{}odom\_tracker\_node"{}});}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00120}00120   \mbox{\hyperlink{classCpOdomTrackerActionServer}{CpOdomTrackerActionServer}} as;}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00121}00121 }
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00122}00122   as.\mbox{\hyperlink{classCpOdomTrackerActionServer_a87b52becfbea05097d198d3ac0386d3c}{run}}();}
\DoxyCodeLine{\Hypertarget{odom__tracker__node_8cpp_source_l00123}00123 \}}
