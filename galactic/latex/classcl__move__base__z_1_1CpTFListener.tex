...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00083}00083   \{}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00084}00084   \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00050}00050   \{}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00051}00051     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} \& poseTrack : \mbox{\hyperlink{classcl__move__base__z_1_1CpTFListener_a22555065516af0d20ea11d72dc4daa9b}{poseTracks\_}})}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00052}00052     \{}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00053}00053       tf2::Stamped<tf2::Transform> transform;}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00054}00054       \textcolor{keywordflow}{try}}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00055}00055       \{}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00056}00056         \{}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00057}00057           std::lock\_guard<std::mutex> lock(\mbox{\hyperlink{classcl__move__base__z_1_1CpTFListener_aaf49a2f8524426920ae22fbc692a853d}{listenerMutex\_}});}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00058}00058           \mbox{\hyperlink{classcl__move__base__z_1_1CpTFListener_a05fea45b9937ab9de6ea33f701946291}{tfListener\_}}-\/>lookupTransform(}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00059}00059             poseTrack-\/>referenceBaseFrame\_, poseTrack-\/>targetPoseFrame\_, rclcpp::Time(0),}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00060}00060             transform);}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00061}00061         \}}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00062}00062 }
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00063}00063         \{}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00064}00064           std::lock\_guard<std::mutex> guard(\mbox{\hyperlink{classcl__move__base__z_1_1CpTFListener_adf87e22c71f56e64622e7046bcf68ffe}{m\_mutex\_}});}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00065}00065           poseTrack-\/>pose\_.pose = \mbox{\hyperlink{namespacecl__move__group__interface_ab841bba9b3a7dc4832356bb485f3a5c8}{tf2::toMsg}}(transform);}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00066}00066           poseTrack-\/>pose\_.header.stamp = transform.stamp\_;}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00067}00067           poseTrack-\/>pose\_.header.frame\_id = poseTrack-\/>referenceBaseFrame\_;}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00068}00068           poseTrack-\/>isInitialized = \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00069}00069         \}}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00070}00070       \}}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00071}00071       \textcolor{keywordflow}{catch} (tf2::TransformException ex)}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00072}00072       \{}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00073}00073         RCLCPP\_ERROR\_STREAM\_THROTTLE(}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00074}00074           1, \textcolor{stringliteral}{"{}[Component pose] (getLogger(), "{}} << poseFrameName\_ << \textcolor{stringliteral}{"{}/["{}} << referenceFrame\_}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00075}00075                                                << \textcolor{stringliteral}{"{}] ) is failing on pose update : "{}} << ex.what());}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00076}00076       \}}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00077}00077     \}}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00078}00078   \}}

\end{DoxyCode}


References \mbox{\hyperlink{cp__tf__listener_8hpp_source_l00094}{listener\+Mutex\+\_\+}}, \mbox{\hyperlink{cp__tf__listener_8hpp_source_l00096}{m\+\_\+mutex\+\_\+}}, \mbox{\hyperlink{cp__tf__listener_8hpp_source_l00097}{pose\+Tracks\+\_\+}}, \mbox{\hyperlink{cp__tf__listener_8hpp_source_l00093}{tf\+Listener\+\_\+}}, and \mbox{\hyperlink{cb__pouring__motion_8cpp_source_l00040}{cl\+\_\+move\+\_\+group\+\_\+interface\+::to\+Msg()}}.
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classcl__move__base__z_1_1CpTFListener_a0bdf03c329aab2ea038b67e51996a515_cgraph}
\end{center}
\end{figure}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00088}00088   \{}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00089}00089     tracks\_}
\DoxyCodeLine{\Hypertarget{classcl__move__base__z_1_1CpTFListener_l00090}00090   \}}
